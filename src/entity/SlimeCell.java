...
public class SlimeCell extends Entity
{
	...
	public void configureHitbox(float length)
	{
		...
		walls[4] = new AABB(offsetPosition, new Vector3f(length, thickness, length), new Vector3f(0, 0, 0), IHitBox.Type.FLOOR);
		walls[5] = new AABB(offsetPosition, new Vector3f(length, thickness, length), new Vector3f(0, length, 0), IHitBox.Type.FLOOR);
